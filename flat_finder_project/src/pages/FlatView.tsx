    ...
    <>
      <div className=" flex flex-col w-full ">
        <div className="flex justify-items-center justify-self-center">
          {currentFlat.length ? (
            <div className="flex flex-col w-[50%] justify-center items-center mt-20 mx-auto p-4 gap-10 border-none rounded-lg bg-[#F6F7FC]  shadow-md">
              ...
              {currentFlat[0].ownerId === loggedUser && (
                <button
                  ...
                  className="text-[12px] w-20 text-center bg-[#F1654D] p-1 rounded-md text-white font-semibold"
                >
                  Edit Flat
                </button>
              )}
            ...
            <div className="flex flex-col w-[90%] justify-center items-center mt-20 mx-auto p-4 gap-10 border-none rounded-lg bg-[#F6F7FC]  shadow-md"></div>
          )}
          <div>
            {currentFlat.length && currentFlat[0].ownerId !== loggedUser ? (
              ...
              currentMessage.map((message) => (
                <div className="flex flex-col h-[30%] w-[70%] justify-center items-start mt-10 mx-auto gap-2 border-none rounded-lg bg-[#F6F7FC]  shadow-md">
                  <p className="text-xs text-[#173466] font-semibold pl-3">
